...
public class ResourceOptimism_old extends AbstractFlaky {
...
//	Valid class but not methods hmmmm.
	...
	public void runAnalysis(CompilationUnit testFileCompilationUnit, CompilationUnit productionFileCompilationUnit,
		...
		ResourceOptimism_old.ClassVisitor classVisitor;
		classVisitor = new ResourceOptimism_old.ClassVisitor();
