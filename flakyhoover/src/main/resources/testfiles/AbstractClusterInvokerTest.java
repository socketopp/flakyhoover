...
//		Set<List<Integer>> sizeOptions = Sets.cartesianProduct(ImmutableList.of(BLOCK_SIZES, CACHE_SIZES));
...
//		.from(Arrays.asList(RegularFileTestRunner.class.getDeclaredMethods())).filter(new Predicate<Method>() {
//			@Override
...
//
///**
// * Different strategies for handling reuse of disks and/or files between tests,
// * intended to ensure that {@link HeapDisk} operates properly in a variety of
// * usage states including newly created, having created files that have not been
// * deleted yet, having created files that have been deleted, and having created
// * files some of which have been deleted and some of which have not.
// */
...
//		file.closed();
//
//		// don't check anything else; no guarantee of what if anything will happen once
//		// the file is
