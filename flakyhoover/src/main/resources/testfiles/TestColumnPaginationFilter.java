 ...
 * serialization of the filter. More test functionality can be found within
...
public class TestColumnPaginationFilter extends TestCase {
	...
	/**
	 * The more specific functionality tests are contained within the TestFilters
	 * class. This class is mainly for testing serialization
	 *
	 * @param filter
	 * @throws Exception
	 */
